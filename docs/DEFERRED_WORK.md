...
The following work is intentionally outside the June 29, 2026 documentation and repository-hygiene pass:
...
- Implement any future contact, donation, registration, payment, webhook, database, or transactional workflow only under separate approved scope.
