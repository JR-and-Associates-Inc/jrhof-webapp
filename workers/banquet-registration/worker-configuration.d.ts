/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.banquet-preview.jsonc workers/banquet-registration/worker-configuration.d.ts` (hash: 6fabfbb170ab0bb6372959ac0791131a)
// Runtime types generated with workerd@1.20260730.1 2026-07-08 nodejs_compat
interface __BaseEnv_Env {
	BANQUET_DB: D1Database;
	BANQUET_CHECKOUT_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	ENVIRONMENT: "local-preview";
	BANQUET_PREVIEW_ROLE: "board-review";
	BANQUET_ALLOWED_ORIGINS: ["http://127.0.0.1:8787","http://localhost:8787"];
	BANQUET_SUCCESS_URL: "http://127.0.0.1:8787/events/induction-banquet/2027-hall-of-fame-induction-banquet/register/?checkout=success";
	BANQUET_CANCEL_URL: "http://127.0.0.1:8787/events/induction-banquet/2027-hall-of-fame-induction-banquet/register/?checkout=canceled";
	ACCESS_TEAM_DOMAIN: "replace-with-team.cloudflareaccess.com";
	ACCESS_AUD: "replace-with-preview-access-application-audience";
	STRIPE_SECRET_KEY: string;
	STRIPE_WEBHOOK_SECRET: string;
	BOARD_REPORT_ALLOWED_EMAILS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BANQUET_PREVIEW_ROLE" | "BANQUET_ALLOWED_ORIGINS" | "BANQUET_SUCCESS_URL" | "BANQUET_CANCEL_URL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "BOARD_REPORT_ALLOWED_EMAILS">> {}
}
