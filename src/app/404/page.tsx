...
export default function NotFoundPage() {
  return (
    <main className="w-full max-w-screen-md mx-auto my-12 px-4 sm:px-6 lg:px-8 py-8 bg-white/85 rounded-[12px] shadow-lg text-center">
      <h1 className="text-5xl font-bold mb-4 text-red-700 drop-shadow-sm">⚾ Strike Three!</h1>
