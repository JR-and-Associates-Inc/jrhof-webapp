  ...
  return (
    <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="bg-white/85 dark:bg-[#2a2a2a]/85 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-6">
        <h1 className="text-4xl font-bold text-center mb-4">2024 HOF Induction Banquet</h1>
        <p className="text-center text-lg text-gray-700 dark:text-gray-300 mb-6">
          Relive the 2024 Hall of Fame Induction Banquet. Browse the Program and photo gallery from this memorable event.
        </p>

        {/* Thumbnail image or program icon */}
        <div className="flex justify-center mb-6">
          <img
            src="https://cdn.jrhof.org/events/hof-banquet/2024/hof-banquet-2024-thumbnail2.png" // Replace with actual program image or placeholder
            alt="2024 HOF Banquet Program"
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-6">
          <a
            href="https://cdn.jrhof.org/events/hof-banquet/2024/JR%20HOF%20Program%202024.pdf"
            target="_blank"
