    ...
    <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="bg-white/85 dark:bg-[#2a2a2a]/85 rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-6 mb-8">
        ...
        <p className="text-center text-lg text-gray-700 dark:text-gray-300 mb-6">
          Relive the 2023 Hall of Fame Induction Banquet. Browse the Program from this memorable event.
        </p>
        <div className="flex justify-center mb-6">
          <img
            src="https://cdn.jrhof.org/events/hof-banquet/2023/hof-banquet-2023-thumbnail2.png"
