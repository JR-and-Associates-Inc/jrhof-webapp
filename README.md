...
- R2 serves approved optimized media through `https://media.jrhof.org`: event galleries and, since the inductee portrait cutover, all inductee portraits and the shared placeholder. No inductee portrait binary is served from Git. Event-photo originals belong in an organization-controlled Google Drive or SharePoint archive, not Git or public R2.
